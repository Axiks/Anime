...
Rails.application.config.assets.precompile += %w( navs.css )
...
Rails.application.config.assets.precompile += %w( topic.css)
Rails.application.config.assets.precompile += %w( all-topics.css)