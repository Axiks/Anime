...
ActiveRecord::Schema.define(version: 2019_05_20_170928) do
  ...
  create_table "topic_comments", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["comment_id"], name: "index_topic_comments_on_comment_id"
  ...
  create_table "writings", force: :cascade do |t|
    t.integer "type"
    t.integer "shikimoryId"
    t.integer "my_anime_list_Id"
    t.string "shikimory_img"
    t.string "name_ua"
    t.string "name_jp"
    t.string "name_en"
    t.string "name_ru"
